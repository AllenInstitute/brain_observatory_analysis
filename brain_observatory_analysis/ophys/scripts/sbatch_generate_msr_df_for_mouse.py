...
if __name__ == '__main__':
    ...
    for data_type in data_types:
        for event_type in event_types:
            job_count += 1
            print(f'CLUSTER JOB: {event_type} {data_type}, job count = {job_count}')

            job_title = f'msr_df_{event_type}_{data_type}'
            walltime = '01:00:00'
            mem = '5G'
            # tmp = '3G',
            ...
            args_string = f"--event_type {event_type} --data_type {data_type}"
            print(args_string)
