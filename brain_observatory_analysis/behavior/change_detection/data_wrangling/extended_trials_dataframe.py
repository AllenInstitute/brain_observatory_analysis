...
def create_extended_dataframe(core_data: dict,
                              visual_stimuli: bool = None,
                              *args,
                              **kwargs) -> pd.DataFrame:
    ...
    try:
        ...
        logger.warning("Could not remove repeated licks: {}".format(e))

    if 'index' in trials.columns:
        trials = trials.drop(columns=['index'])
